...
nav_order: 6
---
This is an example code on how one might integrate plugin into their project.

```dart
import 'package:flutter/material.dart';
import 'package:setupad_prebid_flutter/prebid_mobile.dart';
import 'package:setupad_prebid_flutter/prebid_auction.dart';
...
void main() {
  ...
  const PrebidMobile().initializeSDK("apptest");
  runApp(const MyApp());
}
...
class MyAppState extends StatefulWidget {
  const MyAppState({super.key, required this.title});
